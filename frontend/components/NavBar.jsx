...
export default function NavBar({ active }) {
  return (
    <nav style={{
      ...
      padding: '16px 32px', background: '#18181b', color: '#fff', boxShadow: '0 2px 8px #0002',
      position: 'sticky', top: 0, zIndex: 100
    }}>
      <div style={{ fontWeight: 700, fontSize: 22 }}>Multi-Gateway</div>
      <div style={{ display: 'flex', gap: 24 }}>
        <Link href="/" legacyBehavior><a style={{ color: active === 'dashboard' ? '#a78bfa' : '#fff', textDecoration: 'none', fontWeight: 500 }}>Dashboard</a></Link>
